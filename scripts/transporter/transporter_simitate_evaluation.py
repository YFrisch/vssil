...
if __name__ == "__main__":
    ...
    args.config = "/home/yannik/vssil/results/transporter_simitate/2021_12_29_14_21/config.yml"
    ...
    data_set = Subset(dataset=data_set, indices=[400])
    ...
    transporter_agent.load_checkpoint(
        "/home/yannik/vssil/results/transporter_simitate/2021_12_29_14_21/checkpoints/chckpt_f0_e90.PTH",
        map_location='cpu'
    )
    ...
    with torch.no_grad():
        for i, (sample, label) in enumerate(eval_data_loader):
            ...
            play_series_and_reconstruction_with_keypoints(image_series=(samples - 0.5).clip(-0.5, 0.5),
                                                          reconstruction=(reconstructions - 0.5).clip(-0.5, 0.5),
